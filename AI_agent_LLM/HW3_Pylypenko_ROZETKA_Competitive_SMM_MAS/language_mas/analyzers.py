...
GRAMMAR_RULES = (
    ...
    ("приймайте участь", "беріть участь", "GRAM.LEX.002", Category.GRAMMAR, "Нормативна наказова конструкція — «беріть участь».", 0.98),
    ...
    ("самий вигідний", "найвигідніший", "GRAM.DEGREE.003", Category.GRAMMAR, "Найвищий ступінь прикметника утворюємо префіксом «най-».", 0.98),
